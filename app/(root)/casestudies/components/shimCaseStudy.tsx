        ...
        <>
            <section className='relative h-screen w-full md:px-[5%] px-5'>
                <div className='relative h-[85%] md:h-[90%] w-full'>
                    <Image src={"/assets/images/girls-group.jpg"} alt='BG Image' fill className='object-cover' />
                    <div className='absolute top-0 left-0 h-full w-full inner-shadow'></div>
                    <h2 className='text-4xl md:text-5xl lg:text-6xl text-center font-bold letter tracking-widest relative z-20 top-[40%]'>SHIM CASE STUDY</h2>
                    <div className='grid grid-cols-2 grid-rows-2 md:grid-rows-1 md:grid-cols-4 gap-0 md:gap-0 absolute -bottom-5 md:left-[5%] z-10 w-full md:w-11/12 bg-secondaryBGColor py-10 px-10 md:px-[2%] lg:px-10 rounded-xl outer-shadow'>
                        <div>
                            <div className='flex flex-col items-center text-center pr-5 md:pr-0'>
                                <CountdownCaseStudy initialCount={60} symbol={"%"} timeDuration={50} iterationCount={2} />
                                <p className='text-sm'>Facebook Growth</p>
                            </div>
                        </div>
                        <div>
                            <div className='flex flex-col items-center border-l-2 py-2 pl-5 md:pl-0 text-center'>
                                <CountdownCaseStudy initialCount={80} symbol={"%"} timeDuration={40} iterationCount={2} />
                        ...
                        <div>
                            <div className='flex flex-col items-center md:border-l-2 border-t-2 md:border-t-0 py-2 text-center pr-5 md:pr-0'>
                                <CountdownCaseStudy initialCount={2} symbol={"years"} timeDuration={750} iterationCount={1} />
                        ...
                        <div>
                            <div className='flex flex-col items-center border-l-2 py-2 text-center pl-5 md:pl-0 border-t-2 md:border-t-0'>
                                <CountdownCaseStudy initialCount={2} symbol={"x"} timeDuration={750} iterationCount={1} />
            ...
            <section className='flex flex-col gap-14 pb-10'>
                <div className='flex flex-col items-center gap-5'>
                    ...
                    <p className='text-textColor md:w-4/5 lg:w-1/2 text-center'>Sant Hirdaram institute of Management, Bhopal is an only women’s institute and the only institute in MP which provides IMBA right after 12 th class along with MBA programs. It is committed to facilitate holistic-cum-professional development of the students in terms of realistic learning with endowed ethical values.</p>
                    <p className='text-textColor md:w-4/5 lg:w-1/2 text-center'>In March 2022, our collaboration with them started with a clear objective to make the most of organic marketing across various social media platforms, targeting the right audience in order to achieve great results.</p>
                </div>
                    ...
                    <div className='bg-secondaryBGColor h-full w-full flex flex-col lg:flex-row overflow-hidden rounded-lg'>
                        ...
                        <div className='py-5 my-auto lg:w-[60%]'>
                            ...
                            <ul className='text-textColor text-sm list-disc flex flex-col gap-3 pr-5 pl-10 md:px-0 md:pl-20'>
                                <li>Under Rebranding & Reach came several different small objectives</li>
                                <li>Increase Admission Inquiry organically</li>
                                <li>Achieve limited number of admission seats</li>
                                <li>Achieved an 80% overall growth of traffic on all social media platforms</li>
                ...
                <div className='md:px-[10%]'>
                    <div className='bg-secondaryBGColor h-full w-full flex flex-col lg:flex-row overflow-hidden rounded-lg'>
                        ...
                        <div className='py-5 my-auto lg:w-[60%]'>
                            ...
                            <ul className='text-textColor text-sm list-disc flex flex-col gap-3 pr-5 pl-10 md:px-0 md:pl-20'>
                                <li>Outdated website: The website was old and poorly executed, resulting in lower traffic on the website due to its lack of desirable features and easy handle</li>
                                <li>Unoptimized Social media platforms; Their social media pages were underutilised which hindered their maximum reach</li>
                                <li>Improper Advertising techniques: Prior to working with us, they allocated a certain budget for advertising which lead to limited results. However, we transformed the outcomes by achieving significant results at a minimal cost</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className='flex flex-col md:flex-row gap-10 md:gap-5 md:justify-between md:px-[10%]'>
                    <div className='bg-secondaryBGColor p-[10%] md:p-[5%] flex flex-col gap-10 items-center md:rounded-lg md:w-1/2'>
                        ...
                        <ul className='text-textColor list-disc flex flex-col gap-5'>
                            ...
                            <li>Personalised Ad and marketing Funnels that gave us appropriate results</li>
                            <li>Collaborated with different city pages to reach more target audience all over the state</li>
                        </ul>
                    </div>
                    <div className='bg-secondaryBGColor p-[10%] md:p-[5%] flex flex-col gap-10 items-center md:rounded-lg md:w-1/2'>
                        ...
                        <ul className='text-textColor list-disc flex flex-col gap-5'>
                            ...
                            <li>The account and website experienced a twofold increase in growth</li>
