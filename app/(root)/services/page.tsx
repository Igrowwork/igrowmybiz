...
export default function Page() {
  return (
    <main className='w-full bg-secondaryColor flex flex-col gap-8 md:gap-10 xl:gap-16 pt-10'>
      ...
      <section className='grid lg:grid lg:grid-cols-4 grid-cols-3 gap-6 h-screen w-full justify-center flex-wrap px-5 lg:px-32 py-14 text-black'>
        ...
        <div className='bg-[#242424] lg:col-span-2 row-span-1 rounded-xl flex items-center justify-center hover:scale-105 border-none hover:border-solid hover:border-white/70 hover:border transition-all duration-300 ease-in relative'><Image src={'/assets/Web Icons SMM/SMM icons 3.png'} alt='smm1' fill className='object-contain rounded-xl' /></div>
        <Link href={'/service/socialmediamarketing'} className='col-span-3 lg:col-span-2 row-span-1 rounded-xl hover:scale-[1.03] transition-all duration-300 ease-in p-1 btn-background'><div className='bg-textColor hover:bg-white h-full w-full flex items-center justify-center rounded-xl transition-all duration-300 ease-in'><h3 className='text-black xl:text-4xl font-semibold uppercase text-xl'>Social Media Marketing</h3></div></Link>
      ...
      <section className='grid lg:grid lg:grid-cols-4 grid-cols-3 gap-6 h-screen w-full justify-center flex-wrap px-5 lg:px-32 py-14 text-black'>
        <div className='bg-[#242424] col-span-1 lg:row-span-2 rounded-xl flex items-center justify-center hover:scale-105 border-none hover:border-solid hover:border-white/70 hover:border transition-all duration-300 relative'><Image src={'/assets/Web Icons padi ads/Paid ads management icons 1.png'} alt='paidads' fill className='object-contain rounded-xl' /></div>
        <div className='bg-[#242424] col-span-1 lg:row-span-1 rounded-xl flex items-center justify-center hover:scale-105 border-none hover:border-solid hover:border-white/70 hover:border transition-all duration-300 relative'><Image src={'/assets/Web Icons padi ads/Paid ads management icons 2.png'} alt='paidads' fill className='object-contain rounded-xl' /></div>
        <div className='bg-[#242424] col-span-1 lg:col-span-2 lg:row-span-1 rounded-xl flex items-center justify-center hover:scale-105 border-none hover:border-solid hover:border-white/70 hover:border transition-all duration-300 relative'><Image src={'/assets/Web Icons padi ads/Paid ads management icons 3.png'} alt='paidads' fill className='object-contain rounded-xl' /></div>
        <Link href={'/service/paidads'} className='lg:col-span-2 col-span-3 lg:row-span-1 rounded-xl hover:scale-[1.03] transition-all duration-300 ease-in p-1 btn-background'><div className='bg-textColor hover:bg-white h-full w-full flex items-center justify-center rounded-xl transition-all duration-300 ease-in'><h3 className='text-black xl:text-4xl font-semibold uppercase text-2xl'>paid ads management</h3></div></Link>
      ...
      <section className='grid lg:grid lg:grid-cols-4 grid-cols-3 gap-6 h-screen w-full justify-center flex-wrap px-5 lg:px-32 py-14 text-black'>
        ...
        <Link href={'/service/development'} className='lg:col-span-2 col-span-3 lg:row-span-1 rounded-xl hover:scale-[1.03] transition-all duration-300 ease-in p-1 btn-background'><div className='bg-textColor hover:bg-white h-full w-full flex items-center justify-center rounded-xl transition-all duration-300 ease-in'><h3 className='text-black md:text-4xl font-semibold uppercase text-2xl'>development</h3></div></Link>
      ...
      <section className='grid lg:grid lg:grid-cols-4 grid-cols-3 gap-6 h-screen w-full justify-center flex-wrap px-5 lg:px-32 py-14 text-black'>
        ...
        <Link href={'/service/design'} className='lg:col-span-2 col-span-3 lg:row-span-1 rounded-xl hover:scale-[1.03] transition-all duration-300 ease-in p-1 btn-background'><div className='bg-textColor hover:bg-white h-full w-full flex items-center justify-center rounded-xl transition-all duration-300 ease-in'><h3 className='text-black md:text-3xl font-semibold uppercase text-2xl'>designing services</h3></div></Link>
