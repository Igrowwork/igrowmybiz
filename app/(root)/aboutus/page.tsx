...
const TeamCardComponent = [
  ...
  },
  {
    ...
    expertise: 'Helping clients communicate and appealing image through digital media.'
  },
  {
  ...
  },
  {
    ...
    expertise: 'Video & Audio Editing & also has expertise in story telling in a engaging way.'
  },
  {
    image: 'Shikha_Tomar.jpg',
    position: 'Automation & Funnel Executive',
    expertise: 'Client relationship management & expertise in building funnels for tech starters.'
  },
  {
    image: 'sneha.jpg',
    ...
    <main className='bg-secondaryColor '>
      ...
      <section className='py-10 flex flex-col gap-5'>
        ...
        <div className='w-4/5 mx-auto flex flex-col gap-5 md:grid grid-cols-6'>
          {TeamCardComponent.map((team, index) => <TeamCard key={index} image={team.image} position={team.position} expertise={team.expertise} />)}
        </div>
      </section>
    </main>
  )
