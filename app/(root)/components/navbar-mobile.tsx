                        ...
                        <AccordionItem value="item-1" className="w-fit border-none">
                            ...
                            <AccordionContent>
                                <ul className='flex flex-col gap-3 bg-black py-5'>
                                    {blogsRoutes.map((route) => <SheetClose key={route.href} asChild><Link href={route.href}><li className={cn('text-textColor hover:text-white text-base px-5', route.active ? '' : 'text-textColor')}>{route.label}</li></Link></SheetClose>)}
                                </ul>
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
