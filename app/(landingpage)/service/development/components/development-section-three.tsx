...
import { FileEdit, Database, Gauge, ActivitySquare } from 'lucide-react'
        ...
        <section className='pt-10 bg-black'>
                    ...
                    <div className='grid lg:grid lg:grid-cols-4 grid-cols-1 grid-rows-2 gap-4 w-full md:flex justify-center flex-wrap'>
                        <div className='p-[2px] w-full h-28 md:h-full rounded-md col-span-1 row-span-2 whiteShadow transition-all ease-in-out'>
                            <Card className='bg-[#242424] w-full h-full border-0 col-span-1 row-span-2  flex justify-center items-center'>
                                <CardHeader className='items-center'>
                                    <FileEdit className='text-mainColor w-10 h-10 md:w-10 md:h-10' />
                                    <h3 className='text-mainColor md:text-xl text-lg wrap font-semibold text-center'><span className='text-white'>Specialized </span>Content Writing</h3>
                                </CardHeader>
                            </Card>
                        </div>
                        <div className='p-[2px] w-full h-28 md:h-full rounded-md lg:col-span-2 col-span-1 row-span-1  whiteShadow transition-all ease-in-out'>
                            <Card className='bg-[#242424] border-0 justify-center items-center flex w-full h-full'>
                                <CardHeader className='items-center'>
                                    <Database className='text-mainColor w-10 h-10 md:w-10 md:h-10' />
                                    <h3 className='text-mainColor text-lg md:text-xl wrap font-semibold text-center'><span className='text-white'>Build on </span>Latest Tech Stack</h3>
                                </CardHeader>
                            </Card>
                        </div>
                        ...
                        <div className='p-[2px] w-full h-28 md:h-full rounded-md col-span-1 row-span-1  whiteShadow transition-all ease-in-out'>
                            <Card className='bg-[#242424] border-0  flex justify-center items-center w-full h-full'>
                                <CardHeader className='items-center'>
                                    <Gauge className='text-mainColor w-10 h-10 md:w-10 md:h-10' />
                                    <h3 className='text-mainColor text-lg md:text-xl wrap font-semibold text-center'><span className='text-white'>Minimum </span>Loading Time</h3>
                                </CardHeader>
                            </Card>
                        </div>
                        <div className='p-[2px] w-full h-28 md:h-full rounded-md lg:col-span-2 col-span-1 row-span-1  whiteShadow transition-all ease-in-out'>
                            <Card className='bg-[#242424] border-0  flex justify-center items-center w-full h-full'>
                                <CardHeader className='items-center'>
                                    ...
                                    <h3 className='text-mainColor text-lg md:text-xl wrap font-semibold text-center'><span className='text-white'>Custom webiste form with </span>Easy to access DataBase</h3>
                                </CardHeader>
                            </Card>
                        </div>
                    </div>
            ...
            <div className='py-4 border-mainColor border-y-4 sm:h-28 h-24 mt-10'>
                <div className='overflow-hidden relative h-full w-[90%] xl:w-4/5 mx-auto my-auto'>
                    <div className='flex absolute logo-scroll-three justify-evenly gap-5 w-full'>
                        ...
                        <div className='relative grow-0 shrink-0 w-12 h-12 sm:w-16 sm:h-16'>
                            <Image src={'/assets/images/typescript.svg'} alt='bbb' fill className='filter grayscale hover:grayscale-0 object-contain' />
                        </div>
                        <div className='relative grow-0 shrink-0 w-12 h-12 sm:w-16 sm:h-16 bg-white px-2'>
                            <Image src={'/assets/images/nextjs.svg'} alt='bbb' fill className='object-contain' />
                        </div>
                        <div className='relative grow-0 shrink-0 w-12 h-12 sm:w-16 sm:h-16'>
                            <Image src={'/assets/images/redis.svg'} alt='bbb' fill className='filter grayscale hover:grayscale-0 object-contain' />
                        </div>
                        <div className='relative grow-0 shrink-0 w-12 h-12 sm:w-16 sm:h-16 bg-white'>
                            <Image src={'/assets/images/mongodb.svg'} alt='bbb' fill className='filter grayscale hover:grayscale-0 object-contain' />
                        </div>
                    </div>
                </div>
            </div>
