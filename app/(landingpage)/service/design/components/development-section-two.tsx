                ...
                <div className='w-[90%] lg:w-1/2 mx-auto flex flex-col gap-6 lg:gap-6 py-10'>
                    ...
                    <div className='flex text-gray-400 justify-between sm:justify-evenly lg:justify-start lg:gap-20 items-center text-sm sm:text-base md:text-lg'>
                        <ul className='flex flex-col gap-4'>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />Logo Design </li>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />Motion Graphics </li>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />Videos storytelling redefined </li>
                        </ul>
                        <ul className='flex flex-col gap-4'>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />Packaging design</li>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />Ads Production </li>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />Graphics and Identity</li>
                        </ul>
                    </div>
