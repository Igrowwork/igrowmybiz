        ...
        <section className='relative h-[70vh] md:h-screen w-full hero'>
            ...
            <div className='w-full h-full flex justify-center items-center flex-col gap-10 bg-black'>
                <div className='lg:w-3/4 xl:w-1/2 md:w-2/3 flex flex-col gap-2 relative mt-14'>
                    <p className={cn('text-mainColor text-center text-base sm:text-xl lg:text-3xl  ', dancing_script.className)}>we can show you </p>
                    <h1 className='text-white flex flex-col items-center justify-center text-3xl lg:text-7xl sm:text-5xl gap-1 lg:gap-4 font-bold text-center'>How Design can <span className='text-mainColor'>show your message</span></h1>
