...
import { BuyerPersonaForm } from './components/buyer-persona-form'

export default function Page() {
    return (
        <div className='min-h-screen bg-secondaryColor'>

            <div className='bg-none h-fit w-full relative px-5 lg:px-20 flex justify-between items-center smoothWhiteShadow'>
                <Link href={'/services'}>
            ...
            <div className='p-6'>
                <div className='h-full w-full max-w-2xl mx-auto flex flex-col gap-10'>
                    <h2 className="text-center sm:text-start py-8 text-white text-2xl sm:text-3xl lg:text-4xl font-bold">Buyer Persona Form</h2>
                    <BuyerPersonaForm />
                </div>
            </div>
