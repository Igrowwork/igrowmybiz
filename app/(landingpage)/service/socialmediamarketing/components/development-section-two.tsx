        ...
        <section className='bg-black h-fit pt-10'>
            <div className='lg:flex lg:flex-row-reverse lg:w-4/5 mx-auto items-center'>
                <div className='w-[80%] lg:w-1/2 mx-auto float lg:ml-20 flex items-center justify-center'>
                    <img src="/assets/images/social media marketing-01.png" alt="media" className='h-72 lg:h-80' />
                </div>
                <div className='w-[90%] lg:w-1/2 mx-auto flex flex-col gap-6 lg:gap-6 py-10'>
                    ...
                    <p className='text-gray-400 text-center lg:text-left text-sm sm:text-base md:text-lg'>We offer creative social media solutions towards your business/brand</p>
                    <div className='flex text-gray-400 justify-between sm:justify-evenly lg:justify-start lg:gap-20 items-start text-sm sm:text-base md:text-lg'>
                        <ul className='flex flex-col gap-4'>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />Social Media Marketing</li>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />Content Marketing</li>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />Influencer Marketing</li>
                        </ul>
                        <ul className='flex flex-col gap-4'>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />Account Management</li>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />PR & Collaborations</li>
                        </ul>
                    </div>
