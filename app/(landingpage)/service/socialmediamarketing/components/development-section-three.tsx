...
import { Gauge, ActivitySquare, CalendarClock, Filter, Users2,} from 'lucide-react'
                    ...
                    <div className='grid lg:grid lg:grid-cols-4 grid-cols-1 grid-rows-2 gap-4 w-full md:flex justify-center flex-wrap'>
                        <div className='p-[2px] w-full h-28 md:h-full rounded-md col-span-1 row-span-2 whiteShadow transition-all ease-in-out'>
                            <Card className='bg-[#242424] w-full h-full border-0 col-span-1 row-span-2  flex justify-center items-center'>
                                <CardHeader className='items-center'>
                                    <CalendarClock className='text-mainColor w-10 h-10 md:w-10 md:h-10' />
                                    <h3 className='text-mainColor md:text-xl text-lg wrap font-semibold text-center'><span className='text-white'>5+ Years in </span>Social Media Marketing</h3>
                                </CardHeader>
                            </Card>
                        </div>
                        <div className='p-[2px] w-full h-28 md:h-full rounded-md lg:col-span-2 col-span-1 row-span-1  whiteShadow transition-all ease-in-out'>
                            <Card className='bg-[#242424] border-0 justify-center items-center flex w-full h-full'>
                                <CardHeader className='items-center'>
                                    <Filter className='text-mainColor w-10 h-10 md:w-10 md:h-10'/>
                                    <h3 className='text-mainColor text-lg md:text-xl wrap font-semibold text-center'><span className='text-white'>Viral  </span>Content Strategies</h3>
                                </CardHeader>
                            </Card>
                        </div>
                        ...
                        <div className='p-[2px] w-full h-28 md:h-full rounded-md col-span-1 row-span-1  whiteShadow transition-all ease-in-out'>
                            <Card className='bg-[#242424] border-0  flex justify-center items-center w-full h-full'>
                                <CardHeader className='items-center'>
                                    <Users2 className='text-mainColor w-10 h-10 md:w-10 md:h-10'/>
                                    <h3 className='text-mainColor text-lg md:text-xl wrap font-semibold text-center'><span className='text-white'>Meme </span>Marketing</h3>
                                </CardHeader>
                            </Card>
                        </div>
                        <div className='p-[2px] w-full h-28 md:h-full rounded-md lg:col-span-2 col-span-1 row-span-1  whiteShadow transition-all ease-in-out'>
                            <Card className='bg-[#242424] border-0  flex justify-center items-center w-full h-full'>
                                <CardHeader className='items-center'>
                                    ...
                                    <h3 className='text-mainColor text-lg md:text-xl wrap font-semibold text-center'><span className='text-white'>Maximising Organic </span>Lead Growth</h3>
                                </CardHeader>
                            </Card>
                        </div>
                    </div>
