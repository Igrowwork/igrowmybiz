                ...
                <div className='w-[90%] lg:w-1/2 mx-auto flex flex-col gap-6 lg:gap-6 py-10'>
                    ...
                    <div className='flex text-gray-400 justify-between sm:justify-evenly lg:justify-start lg:gap-20 items-start text-sm sm:text-base md:text-lg'>
                        <ul className='flex flex-col gap-4'>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />Facebook & Instagram Ads</li>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />Pay Per Click Ads</li>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />Email Marketing</li>
                        </ul>
                        <ul className='flex flex-col gap-4'>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />Google Ads</li>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />Youtube Ads</li>
                            <li className='flex gap-[2px] items-center'><CheckCircle2 className='mr-2 w-4 h-4' />LinkedIn Ads</li>
                        </ul>
                    </div>
