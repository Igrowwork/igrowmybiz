        ...
        <Card className='bg-[#242424] border-0 w-80 mx-auto grow-0 shrink-0'>
            <CardHeader className='gap-4 h-full justify-between'>
                <div className='flex flex-col gap-4'>
                    <h4 className='text-white font-bold text-2xl text-center flex flex-col gap-3'>{heading} <span className={cn(dancing_script.className, 'text-mainColor text-base -mt-4')}>{tagline}</span></h4>
